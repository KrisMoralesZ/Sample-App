...
class PasswordResetsTest < ActionDispatch::IntegrationTest
  ...
  test 'password resets' do
    ...
    #Invalid password & confitmation
    patch password_resets_path(user.reset_token), params: {
      email: user.email,
      user: {
        password: 'foobaz',
    ...
    assert_select 'div#error_exclamation'

    #Empty password
    patch password_resets_path(usre.reset_token), params: {
      email: user.email,
      user: {
        password: "",
